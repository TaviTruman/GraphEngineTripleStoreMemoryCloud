...
namespace InKnowWorks.TripleStoreMemoryCloud.Protocols.TSL
{
    ...
    /// The target field to query on is specified with <paramref name="query"/>, <seealso cref="InKnowWorks.TripleStoreMemoryCloud.Protocols.TSL.IndexIdentifier"/>.
    /// </summary>
    public class Index
    {
        static Index()
        ...
        /// instance, accessible through InKnowWorks.TripleStoreMemoryCloud.Protocols.TSL.Index.Target_Cell_Name.Target_Field_Name.
        /// </summary>
